        ...
        <div class="quick-pay-wrap">
            ...
            <form id="recharge" name="recharge" method="post" action="#" target="_blank">
              ...
              <div class="pay-bank" id="pay-bank">
                ...
                <ul id="paysSpan" style="height:150px;">
                  <li><img src="images/bank1.png" property1="icbc" class="on"><em></em><i></i></li>
                  <li><img src="images/bank2.png" property1="abc"><em></em></li>
                  <li><img src="images/bank3.png" property1="boc"><em></em></li>
                  <li><img src="images/bank4.png" property1="ccb"><em></em></li>
                  <li><img src="images/bank5.png" property1="hxb"><em></em></li>
                  <li><img src="images/bank6.png" property1="comm"><em></em></li>
                  <li><img src="images/bank7.png" property1="cmb"><em></em></li>
                  <li><img src="images/bank8.png" property1="ceb"><em></em></li>
                  <li><img src="images/bank9.png" property1="cncb"><em></em></li>
                  <li><img src="images/bank10.png" property1="cmsb"><em></em></li>
                  <li><img src="images/bank11.png" property1="cgb"><em></em></li>
                  <li><img src="images/bank12.png" property1="shb"><em></em></li>
                  <li><img src="images/bank13.png" property1="bjb"><em></em></li>
                  <li><img src="images/bank14.png" property1="rcb"><em></em></li>
                  <li><img src="images/bank15.png" property1="cib"><em></em></li>
                </ul>
          ...
          <div class="pay-tipcon2"> <b>温馨提示：</b><br>
            ...
            <div class="alert-450 alert-h220" id="alert-notOpenAccount" style="display: block;">
            	...
            	<div class="alert-main">
            		<form id="userRecharge/list">
		        		<p class="msg6" align="center">
		        			用户在充值或提现前，需开通第三方账户。<br>
		        			此页面将在10秒后自动跳转到开通第三方账户页面<br>
		        			<em id="show-number">0</em>
		        		</p>
		        		<a href="userRecharge/list" id="openAccountAId" class="btn-ok txt-center">马上开通第三方账户</a>
		        	</form>
            	</div>
            </div> 
