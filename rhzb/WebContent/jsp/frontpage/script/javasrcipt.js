...
function WeiBoMove()
{
	document.getElementById("WeiBo").src = "jsp/frontpage/images/微博-hover.png";
}

function WeiBoOut()
{
	document.getElementById("WeiBo").src = "jsp/frontpage/images/微博-link.png";
}

function WeChatMove()
{
	document.getElementById("WeChat").src = "jsp/frontpage/images/微信-hover.png";
}

function WeChatOut()
{
	document.getElementById("WeChat").src = "jsp/frontpage/images/微信-link.png";
}
/*焦点图--------------------------------------------------------------------------------------------------------------*/
var FocusArr = new Array
("url(jsp/frontpage/images/focus1.gif)","url(jsp/frontpage/images/focus2.gif)","url(jsp/frontpage/images/focus3.gif)","url(jsp/frontpage/images/focus4.gif)");
var num = 0;
...
("jsp/frontpage/images/wrap-广发基金.gif","jsp/frontpage/images/wrap-华夏基金.gif","jsp/frontpage/images/wrap-建信基金.gif","jsp/frontpage/images/wrap-汇添富基金.gif","jsp/frontpage/images/wrap-鹏华基金.gif","jsp/frontpage/images/wrap-工银瑞信.gif","jsp/frontpage/images/wrap-易方达基金.gif","jsp/frontpage/images/wrap-景顺长城.gif","jsp/frontpage/images/wrap-博时基金.gif","jsp/frontpage/images/wrap-南方基金.gif","jsp/frontpage/images/wrap-天弘基金.gif","jsp/frontpage/images/wrap-招商基金.gif","jsp/frontpage/images/wrap-银华基金.gif","jsp/frontpage/images/wrap-华安基金.gif");
var i = 0;
