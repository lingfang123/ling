...
public class MailSendUtil {
    ...
    private final static String formName = "zongyidai@vip.qq.com";//你的邮箱
    private final static String password = "sdeqaswpjxpcegai"; //授权码
    private final static String replayAddress = "zongyidai@vip.qq.com"; //你的邮箱
  ...
  //发送html格式的邮箱(群发)
    ...
    private static Message getMessage(MailInfo info) throws Exception{
        ...
        //消息的发送者
        message.setFrom(new InternetAddress(p.getProperty("mail.smtp.user"),"众易贷"));
