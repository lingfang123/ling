...
public class PageInfoUtil {
	 private final static int PAGESIZE = 5; //默认显示的记录数 
	...
	//构造方法
	public PageInfoUtil(int nowpage, int pagesize) {
	    //计算当前页  
	    if (nowpage < 0) {
	        this.nowpage = 1;
	    } else {
	...
	// 构造方法
	public PageInfoUtil(int nowpage, int pagesize, String sort, String order) {
	    // 计算当前页  
	    if (nowpage < 0) {
	        this.nowpage = 1;
	    } else {
